...
{
    public partial class AutoLoadAnimeData : Window
    {
        #region Variaveis
        ...
        private readonly TranslatorMicrossoft translatorMicrossoft = new TranslatorMicrossoft();
        ...
        private async void BtnTraduzir_Click(object sender, RoutedEventArgs e)
        {
            ...
            string traducao = await translator.Translate3(text);
        ...
        private async void Iniciar()
        {
            ...
            tbLinks.box.Text = "";
            int id = Convert.ToInt32(tbId.box.Text);
            string novoID = (id + 1).ToString("0000");
        ...
        private async Task<string> Traduzir(string value)
        {
            ...
            string novoValue = await translator.Translate3(value);
